...
_defineProperty(Elements, "inputs", {
  tierOneNodeAmount: new _InputNode.default('tier-one-node-amount-user-input'),
  tierTwoNodeAmount: new _InputNode.default('tier-two-node-amount-user-input'),
  tierThreeNodeAmount: new _InputNode.default('tier-three-node-amount-user-input'),
  tierFourNodeAmount: new _InputNode.default('tier-four-node-amount-user-input'),
  waitDays: new _InputNode.default('user-wait-days'),
  hasTaxNft: new _InputNode.default('user-has-tax-nft'),
  refreshPricesButton: new _InputNode.default('refresh-prices-button'),
  connectMetamaskButton: new _InputNode.default('connect-metamask-button')
});
